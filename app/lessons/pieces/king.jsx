...
const Pawn = () => {
  ...
  const lesson = [
    ...
    'Король может рубить фигуры, стоящие на полях на которые он сходил.',
    'Если королю поставили шах, он обязан уйти на безопасное поле.',
    'Король не может ходить на поля, находящиеся под ударом.',
  ]
    ...
    <View style={{minHeight: '100%'}}>
        ...
        <div style={styles.container}>
          <div style={styles.lesson__wrapper}>
            <Image source={require('../../images/king1.png')} {...{style: current == 0 ? styles.lesson__image : {display: 'none'}}}/>
            <Image source={require('../../images/king2.png')} {...{style: current == 1 ? styles.lesson__image : {display: 'none'}}}/>
            <Image source={require('../../images/king3.png')} {...{style: current == 2 ? styles.lesson__image : {display: 'none'}}}/>
            <Image source={require('../../images/king4.png')} {...{style: current == 3 ? styles.lesson__image : {display: 'none'}}}/>
